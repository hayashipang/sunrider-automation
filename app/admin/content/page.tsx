    ...
    <div className="min-h-screen bg-dark-900">
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-xl font-bold gradient-text">內容管理</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Content List */}
          <div className="card">
            <h2 className="text-xl font-bold text-white mb-6">網站內容</h2>
            
            <div className="space-y-4">
              {content.map((item) => (
                <div key={item.id} className="border border-dark-600 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-medium text-white">{item.section}</h3>
